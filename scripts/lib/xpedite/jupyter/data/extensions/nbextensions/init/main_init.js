...
/*
 To add toolbar button uncomment the following line
...
/*  To add a celltoolbar functionality for enabling/disabling an init cell,
...
*/
        if (options.run_on_kernel_ready) {
          /* To disable init functionality with untrusted nb, uncomment the following snippet
