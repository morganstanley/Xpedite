...
appInfo = os.path.join(os.path.dirname(__file__), 'reportCmdData', 'xpedite-appinfo.txt')
...
probes = [
  ...
  Probe('Parse Quantity', sysName = 'ParseQty'),
